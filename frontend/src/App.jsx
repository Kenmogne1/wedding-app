  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white overflow-x-hidden">
      ...
      <section className="py-12 md:py-16 px-4 border-t border-gray-800">
       ...
       {/* Admin Button */}
      <button
        onClick={() => window.open('https://wedding-fabrice-ange.vercel.app/admin', '_blank', 'noopener,noreferrer')}
        className="fixed bottom-5 right-5 md:bottom-6 md:right-6 w-5 h-5 md:w-6 md:h-6 bg-gray-800 border border-gray-700 rounded-full hover:bg-gray-700 transition-all flex items-center justify-center shadow-sm z-50"
